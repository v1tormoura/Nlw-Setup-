...
export function HabitDay({ defaultCompleted = 0, amount = 0, date }: HabitDayProps) {
  ...
  return (
    <Popover.Root>
      <Popover.Trigger
        className={clsx('w-10 h-10 border-1 rounded-lg transtion-colors focus:outline-none focus:ring-2 group-focus:ring-blue-600 group-focus:ring-offset-2 group-focus:ring-offset-background', {
          'bg-zinc-900 border-blue-900': completedPercentage === 0,
